...
public class VClientesVariosF extends javax.swing.JDialog {
    
    int x,y;

    public VClientesVariosF(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tblFacturas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Transaccion", "No. Factura", "Cliente", "Usuario", "Total", "Estado"
            }
        ));
        ...
        jLabel5.setText("Listado de Facturas de Clientes Varios");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VClientesVariosF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VClientesVariosF dialog = new VClientesVariosF(new javax.swing.JFrame(), true);
    ...
    private void cargarFacturas(){
        ...
        String[] titulos = {"Transaccion","No. Factura","Usuario","Estado","Total"};
        List<Documento> lista = documento.consultarClientesVarios();
