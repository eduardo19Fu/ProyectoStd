...
public class VCrearRol extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblListaPermisos = new javax.swing.JTable();
        ...
        comboPermisos = new java.awt.Choice();
        ...
        jPanel2.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 250, 810, 10));

        jScrollPane2.setBorder(null);

        tblListaPermisos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblListaPermisos.setFillsViewportHeight(true);
        tblListaPermisos.setGridColor(new java.awt.Color(255, 255, 255));
        tblListaPermisos.setSelectionBackground(new java.awt.Color(0, 153, 153));
        tblListaPermisos.setShowHorizontalLines(false);
        tblListaPermisos.setShowVerticalLines(false);
        tblListaPermisos.getTableHeader().setResizingAllowed(false);
        jScrollPane2.setViewportView(tblListaPermisos);

        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 590, 230));

        jPanel3.setBackground(new java.awt.Color(0, 153, 153));
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 3), "Controles", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Consolas", 1, 13), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 270, 170, 240));

        jPanel7.setBackground(new java.awt.Color(0, 153, 153));
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2), "Datos del Rol", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Consolas", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        jPanel7.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Nombre Rol:");
        jPanel7.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 45, -1, -1));

        txtUsuario.setFont(new java.awt.Font("Consolas", 0, 13)); // NOI18N
        jPanel7.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 43, 203, -1));

        jLabel6.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Permiso:");
        jPanel7.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 50, -1, -1));

        comboPermisos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel7.add(comboPermisos, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 40, 194, 30));

        jLabel4.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Observaciones:");
        jPanel7.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 108, -1, -1));
        ...
        jPanel7.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(148, 97, 575, 74));
        ...
        jPanel7.add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 40, 50, -1));

        jPanel2.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 50, 810, 190));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 820, 560));
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseClicked
        asignarPermiso(String.valueOf(comboPermisos.getSelectedItem()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCrearRol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private java.awt.Choice comboPermisos;
    ...
    private javax.swing.JTable tblListaPermisos;
    ...
    private void cargarChoice(){
        ...
        listaPermiso = per.listar();
        for(int i = 0; i < listaPermiso.size(); i++){
            comboPermisos.addItem(String.valueOf(listaPermiso.get(i).getPermiso()));
        }
    }
    
    // Método encargado de colocar en la tabla de permisos los permisos que el usuario desea asignar 
    // al nuevo rol creado.
    private void asignarPermiso(String permiso){
        ...
        datos[0] = permiso;// Almacena el dato rol dentro del arreglo.
        for(int i = 0; i < tblListaPermisos.getRowCount(); i++){
            if(tblListaPermisos.getValueAt(i, 0).equals(permiso)){
        ...
        if(bandera == false){
            modelo.addRow(datos);
            tblListaPermisos.setModel(modelo);
        }
    }
}
