...
public class VPolizas extends javax.swing.JDialog {
    
    private Usuario usuario;
    private Documento documento;
    int x,y;

    public VPolizas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        fechaIni = new org.jdesktop.swingx.JXDatePicker();
        ...
        comboVendedores.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(fechaIni, javax.swing.GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE))
        ...
        panelTitulo.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 40));
    ...
    private void btnImprimirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnImprimirMouseClicked
        ...
        int idusuario = usuario.consultarUsuario(comboVendedores.getSelectedItem().toString());
        Date fecha = fechaIni.getDate();
        documento.imprimir(idusuario, fecha);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VPolizas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            VPolizas dialog = new VPolizas(new javax.swing.JFrame(), true);
    ...
    private org.jdesktop.swingx.JXDatePicker fechaIni;
    ...
    private void cargarVendedores(){
        ...
        List<Usuario> lista = this.usuario.vendedores();
        
        for(int i = 0; i < lista.size(); i++){
            comboVendedores.addItem(lista.get(i).getUsuario());
        }
    }
}
