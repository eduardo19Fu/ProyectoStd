...
public class VFabricantes extends javax.swing.JDialog {

    int x,y;
    String vendedor;
    
    public VFabricantes(java.awt.Frame parent, boolean modal, String vendedor) {
        super(parent,modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tableFabricante.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Fabricante", "Fabricante", "Observaciones"
            }
        ));
        tableFabricante.setFillsViewportHeight(true);
        tableFabricante.setFocusTraversalPolicyProvider(true);
        tableFabricante.setSelectionBackground(new java.awt.Color(0, 153, 153));
        tableFabricante.setShowHorizontalLines(false);
        tableFabricante.setShowVerticalLines(false);
        tableFabricante.setSurrendersFocusOnKeystroke(true);
        jScrollPane1.setViewportView(tableFabricante);

        jLabel11.setFont(new java.awt.Font("Consolas", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 153, 153));
        jLabel11.setText("Fabricantes:");
    ...
    private void btnActualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnActualizarMouseClicked
        try {
            int id = (int) tableFabricante.getValueAt(tableFabricante.getSelectedRow(), 0);
            VRegistroFabricantes vr = new VRegistroFabricantes(null,true,id);
            vr.setVisible(true);
    ...
    private void btnCrearMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCrearMouseClicked
        VRegistroFabricantes vr = new VRegistroFabricantes(null,true,0);
        vr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VFabricantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            VFabricantes dialog = new VFabricantes(new javax.swing.JFrame(), true, null);
    ...
    private void cargarFabricantes(){
        String[] titulos = {"ID Fabricante","Fabricante","Observaciones"};
        Object[] datos = new Object[3];
        DefaultTableModel modelo = new DefaultTableModel(null,titulos);
        Fabricante fabricante = new Fabricante();
        List<Fabricante> lista = fabricante.listar();
        
        for(int i = 0; i < lista.size(); i++){
           datos[0] = lista.get(i).getIdfabricante();
           datos[1] = lista.get(i).getNombre_fabricante();
           datos[2] = lista.get(i).getObservaciones();
           modelo.addRow(datos);
        }
    ...
    private void filtrar(){
        ...
        DefaultTableModel modelo = new DefaultTableModel(null,titulos);
        Fabricante fabricante = new Fabricante();
        List<Fabricante> lista = fabricante.filtrar(txtBusqueda.getText());
