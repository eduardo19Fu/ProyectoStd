...
public class VCorrelativos extends javax.swing.JDialog {

    int x,y;
    String vendedor;
    
    public VCorrelativos(java.awt.Frame parent, boolean modal, String vendedor) {
        super(parent,modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tableCorrelativos = new javax.swing.JTable();
        ...
        tableCorrelativos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID Usuario", "Usuario", "Serie", "Inicial", "Final", "Actual", "Tipo Documento"
            }
        ));
        tableCorrelativos.setFillsViewportHeight(true);
        tableCorrelativos.setFocusTraversalPolicyProvider(true);
        tableCorrelativos.setSelectionBackground(new java.awt.Color(0, 153, 153));
        tableCorrelativos.setShowHorizontalLines(false);
        tableCorrelativos.setShowVerticalLines(false);
        tableCorrelativos.setSurrendersFocusOnKeystroke(true);
        jScrollPane1.setViewportView(tableCorrelativos);

        jLabel11.setFont(new java.awt.Font("Consolas", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 153, 153));
        jLabel11.setText("Correlativos:");
    ...
    private void btnActualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnActualizarMouseClicked
        UsuarioCorrelativo uco = new UsuarioCorrelativo();
        
        try {
            int tipo = uco.consultarTipo(tableCorrelativos.getValueAt(tableCorrelativos.getSelectedRow(), 6).toString());
            int idusuario = (int) tableCorrelativos.getValueAt(tableCorrelativos.getSelectedRow(), 0);
            VActualizarCorrelativo va = new VActualizarCorrelativo(null, true,idusuario,tipo);
            va.setVisible(true);
        } catch (ArrayIndexOutOfBoundsException e) {
            JOptionPane.showMessageDialog(this, "Debe seleccionar un correlativo para poder proceder con la actualización.","Advertencia",JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_btnActualizarMouseClicked

    private void btnCrearMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCrearMouseClicked
        VUsuarioCorrelativos uc = new VUsuarioCorrelativos(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCorrelativos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            VCorrelativos dialog = new VCorrelativos(new javax.swing.JFrame(), true, null);
    ...
    private javax.swing.JTable tableCorrelativos;
    ...
    private void cargarCorrelativos(){
        String[] titulos = {"ID Usuario","Usuario", "Serie","Inicial","Final","Actual","Tipo Correlativo"};
        Object[] datos;
        DefaultTableModel modelo = new DefaultTableModel(null,titulos);
        UsuarioCorrelativo uc = new UsuarioCorrelativo();
        List<Object> lista = uc.consultar();
        
        for(int i = 0; i < lista.size(); i++){
           datos = (Object[]) lista.get(i);
           modelo.addRow(datos);
        }
        tableCorrelativos.setModel(modelo);
    ...
    private void filtrar(){
        ...
        DefaultTableModel modelo = new DefaultTableModel(null,titulos);
        UsuarioCorrelativo uc = new UsuarioCorrelativo();
        List<Object> lista = uc.consultar(txtBusqueda.getText());
