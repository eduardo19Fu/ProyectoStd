...
public class VCreacionProforma extends javax.swing.JDialog {
    ...
    /**
     * Creates new form VCreacionProforma
     */
    public VCreacionProforma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VCreacionProforma dialog = new VCreacionProforma(new javax.swing.JFrame(), true);
