...
public class VEditarUsuario extends javax.swing.JDialog {
    ...
    public VEditarUsuario(java.awt.Frame parent, boolean modal) {
        super(parent,modal);
        initComponents();
        contador = 0;
        cargarChoice();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VEditarUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            VEditarUsuario dialog = new VEditarUsuario(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JTable tblListaRoles;
