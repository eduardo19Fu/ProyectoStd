...
public class VProformas extends javax.swing.JDialog {

    int x,y;
    String vendedor;
    
    
    public VProformas(java.awt.Frame parent, boolean modal, String vendedor) {
        super(parent,modal);
        initComponents();
        cargarProformas();
    ...
    private void initComponents() {
        ...
        tableProformas = new javax.swing.JTable();
        ...
        tableProformas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tableProformas.setFocusTraversalPolicyProvider(true);
        tableProformas.setSelectionBackground(new java.awt.Color(0, 153, 153));
        tableProformas.setShowHorizontalLines(false);
        tableProformas.setShowVerticalLines(false);
        tableProformas.setSurrendersFocusOnKeystroke(true);
        jScrollPane1.setViewportView(tableProformas);
        ...
        btnReImprimir.setPreferredSize(new java.awt.Dimension(250, 50));
        ...
        btnReImprimir.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel4.setFont(new java.awt.Font("Consolas", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Re Imprimir");
        btnReImprimir.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, -1, -1));
        ...
        jLabel9.setText("Anular Proforma");
    ...
    private void btnFiltroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnFiltroMouseClicked
        buscarProformas(dateIni.getDate(), dateFin.getDate());
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        try{
            ...
            int idtransaccion = (int) tableProformas.getValueAt(tableProformas.getSelectedRow(), 0);
            int no_proforma = (int) tableProformas.getValueAt(tableProformas.getSelectedRow(), 1);
            String serie = String.valueOf(tableProformas.getValueAt(tableProformas.getSelectedRow(), 2));
            String estado = String.valueOf(tableProformas.getValueAt(tableProformas.getSelectedRow(), 5));
            ...
            if(!estado.equals("ANULADA")){
                ...
                if(op != -1){
                    if((op + 1) == 1){
                        if(documento.anularProforma(idtransaccion) > 0){
                            JOptionPane.showMessageDialog(this, "**** Proforma anulada con éxito ****");
                            cargarProformas();
                        }else{
                            JOptionPane.showMessageDialog(this, "La proforma " + no_proforma + " no pudo ser anulada","Error",JOptionPane.ERROR_MESSAGE);
                        }
                    }
                }
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VProformas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            VProformas dialog = new VProformas(new javax.swing.JFrame(), true, null);
    ...
    private javax.swing.JTable tableProformas;
    ...
    private void cargarProformas(){
        ...
        List<Documento> lista = documento.consultarProformas();
    ...
    private void buscarProformas(Date fechaIni, Date fechaFin){
        Documento documento = new Documento();
        Usuario usuario;
        String[] titulos = {"ID Transaccion","No. Proforma","Serie","Vendedor","Fecha Emision","Estado"};
        DefaultTableModel modelo = new DefaultTableModel(null,titulos);
        Object[] datos = new Object[6];
        List<Documento> lista = documento.consultarProformas(fechaIni,fechaFin);
    ...
    private void configurarTabla(JTable table){
        ...
        table.getColumn("No. Proforma").setPreferredWidth(60);
