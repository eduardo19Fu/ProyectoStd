...
public class NotificacionError extends javax.swing.JDialog {
    ...
    int x,y;
    public NotificacionError(java.awt.Frame parent, boolean modal, String texto) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotificacionError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            NotificacionError dialog = new NotificacionError(new javax.swing.JFrame(), true, "");
