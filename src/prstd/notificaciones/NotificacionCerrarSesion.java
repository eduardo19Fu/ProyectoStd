 ...
 * @author Edfu-Pro
 */
public class NotificacionCerrarSesion extends javax.swing.JDialog {

    // Variables que guardarán los enteros de la posición de la ventana.
    int x,y;
    private javax.swing.JFrame principal;
    
    public NotificacionCerrarSesion(java.awt.Frame parent, boolean modal,javax.swing.JFrame ventana) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotificacionCerrarSesion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            NotificacionCerrarSesion dialog = new NotificacionCerrarSesion(new javax.swing.JFrame(), true, null);
